...
public class CustomMediaRouteControllerDialog extends MediaRouteControllerDialog {
    ...
    private final CustomMediaRouteControllerDialog.MediaRouterCallback mCallback;
    ...
    private CustomMediaRouteControllerDialog.VolumeGroupAdapter mVolumeGroupAdapter;
    ...
    private CustomMediaRouteControllerDialog.VolumeChangeListener mVolumeChangeListener;
    ...
    private final CustomMediaRouteControllerDialog.MediaControllerCallback mControllerCallback;
    private PlaybackStateCompat mState;
    private MediaDescriptionCompat mDescription;

    private CustomMediaRouteControllerDialog.FetchArtTask mFetchArtTask;
    ...
    private final Runnable mGroupListFadeInAnimation = this::startGroupListFadeInAnimation;

    public CustomMediaRouteControllerDialog(Context context) {
        this(context, 0);
    }

    private CustomMediaRouteControllerDialog(Context context, int theme) {
        ...
        mControllerCallback = new CustomMediaRouteControllerDialog.MediaControllerCallback();
        mRouter = MediaRouter.getInstance(mContext);
        mCallback = new CustomMediaRouteControllerDialog.MediaRouterCallback();
        mRoute = mRouter.getSelectedRoute();
        setMediaSession(mRouter.getMediaSessionToken());
        mVolumeGroupListPaddingTop = mContext.getResources().getDimensionPixelSize(
                android.support.v7.mediarouter.R.dimen.mr_controller_volume_group_list_padding_top);
        mAccessibilityManager =
                (AccessibilityManager) mContext.getSystemService(Context.ACCESSIBILITY_SERVICE);
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            mLinearOutSlowInInterpolator = AnimationUtils.loadInterpolator(context,
                    android.support.v7.mediarouter.R.interpolator.mr_linear_out_slow_in);
            mFastOutSlowInInterpolator = AnimationUtils.loadInterpolator(context,
                    android.support.v7.mediarouter.R.interpolator.mr_fast_out_slow_in);
        }
    ...
    private void setMediaSession(MediaSessionCompat.Token sessionToken) {
        ...
        try {
            ...
            Timber.e(e, "Error creating media controller in setMediaSession.");
        }
        if (mMediaController != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomMediaRouteControllerDialog.ClickListener listener = new CustomMediaRouteControllerDialog.ClickListener();

        mExpandableAreaLayout = findViewById(android.support.v7.mediarouter.R.id.mr_expandable_area);
        mExpandableAreaLayout.setOnClickListener(v -> dismiss());
        mDialogAreaLayout = findViewById(android.support.v7.mediarouter.R.id.mr_dialog_area);
        mDialogAreaLayout.setOnClickListener(v -> {
        ...
        mCloseButton = findViewById(android.support.v7.mediarouter.R.id.mr_close);
        mCloseButton.setOnClickListener(listener);
        mCustomControlLayout = findViewById(android.support.v7.mediarouter.R.id.mr_custom_control);
        mDefaultControlLayout = findViewById(android.support.v7.mediarouter.R.id.mr_default_control);
            ...
            if (mMediaController != null) {
                ...
                if (pi != null) {
                    try {
                        ...
                        Timber.e(pi + " was not sent, it had been canceled.");
                    }
                }
            }
        };
        mArtView = findViewById(android.support.v7.mediarouter.R.id.mr_art);
        ...
        mMediaMainControlLayout = findViewById(android.support.v7.mediarouter.R.id.mr_media_main_control);
        mDividerView = findViewById(android.support.v7.mediarouter.R.id.mr_control_divider);

        mPlaybackControlLayout = findViewById(android.support.v7.mediarouter.R.id.mr_playback_control);
        mTitleView = findViewById(android.support.v7.mediarouter.R.id.mr_control_title);
        mSubtitleView = findViewById(android.support.v7.mediarouter.R.id.mr_control_subtitle);
        mPlaybackControlButton = findViewById(android.support.v7.mediarouter.R.id.mr_control_playback_ctrl);
        mPlaybackControlButton.setOnClickListener(listener);

        mVolumeControlLayout = findViewById(android.support.v7.mediarouter.R.id.mr_volume_control);
        mVolumeControlLayout.setVisibility(View.GONE);
        mVolumeSlider = findViewById(android.support.v7.mediarouter.R.id.mr_volume_slider);
        mVolumeSlider.setTag(mRoute);
        mVolumeChangeListener = new CustomMediaRouteControllerDialog.VolumeChangeListener();
        mVolumeSlider.setOnSeekBarChangeListener(mVolumeChangeListener);

        mVolumeGroupList = findViewById(android.support.v7.mediarouter.R.id.mr_volume_group_list);
        mGroupMemberRoutes = new ArrayList<>();
        mVolumeGroupAdapter = new CustomMediaRouteControllerDialog.VolumeGroupAdapter(mVolumeGroupList.getContext(),
                mGroupMemberRoutes);
...
//                (MediaRouteVolumeSlider) mVolumeSlider, mMediaMainControlLayout);
        ((MediaRouteVolumeSlider) mVolumeSlider).setColor(getContext().getResources().getColor(R.color.icons));
        mVolumeSliderMap = new HashMap<>();
        mVolumeSliderMap.put(mRoute, mVolumeSlider);

        mGroupExpandCollapseButton =
                findViewById(android.support.v7.mediarouter.R.id.mr_group_expand_collapse);
        mGroupExpandCollapseButton.setOnClickListener(v -> {
        ...
        mGroupListAnimationDurationMs = mContext.getResources().getInteger(
                android.support.v7.mediarouter.R.integer.mr_controller_volume_group_list_animation_duration_ms);
        mGroupListFadeInDurationMs = mContext.getResources().getInteger(
                android.support.v7.mediarouter.R.integer.mr_controller_volume_group_list_fade_in_duration_ms);
        mGroupListFadeOutDurationMs = mContext.getResources().getInteger(
                android.support.v7.mediarouter.R.integer.mr_controller_volume_group_list_fade_out_duration_ms);
    ...
    void updateLayout() {
        ...
        mVolumeGroupListItemIconSize = res.getDimensionPixelSize(
                android.support.v7.mediarouter.R.dimen.mr_controller_volume_group_list_item_icon_size);
        mVolumeGroupListItemHeight = res.getDimensionPixelSize(
                android.support.v7.mediarouter.R.dimen.mr_controller_volume_group_list_item_height);
        mVolumeGroupListMaxHeight = res.getDimensionPixelSize(
                android.support.v7.mediarouter.R.dimen.mr_controller_volume_group_list_max_height);
    ...
    void update(boolean animate) {
        ...
        if (mCustomControlView == null && mArtIconIsLoaded) {
            if (isBitmapRecycled(mArtIconLoadedBitmap)) {
                Timber.tag(TAG).w("Can't set artwork image with recycled bitmap: " + mArtIconLoadedBitmap);
            } else {
    ...
    void updateLayoutHeightInternal(boolean animate) {
        ...
        View decorView = getWindow().getDecorView();
        decorView.measure(
                View.MeasureSpec.makeMeasureSpec(getWindow().getAttributes().width, View.MeasureSpec.EXACTLY),
    ...
    void updateVolumeGroupItemHeight(View item) {
        LinearLayout container = item.findViewById(android.support.v7.mediarouter.R.id.volume_item_container);
        setLayoutHeight(container, mVolumeGroupListItemHeight);
        View icon = item.findViewById(android.support.v7.mediarouter.R.id.mr_volume_item_icon);
    ...
    void clearGroupListAnimation(boolean exceptAddedRoutes) {
        ...
        for (int i = 0; i < mVolumeGroupList.getChildCount(); ++i) {
            ...
            LinearLayout container = (LinearLayout) view.findViewById(android.support.v7.mediarouter.R.id.volume_item_container);
        ...
        if (canShowPlaybackControlLayout()) {
            ...
            if (mState != null) {
                ...
                if (isPlaying && isPauseActionSupported()) {
                    iconDrawableAttr = android.support.v7.mediarouter.R.attr.mediaRoutePauseDrawable;
                    iconDescResId = android.support.v7.mediarouter.R.string.mr_controller_pause;
                } else if (isPlaying && isStopActionSupported()) {
                    iconDrawableAttr = android.support.v7.mediarouter.R.attr.mediaRouteStopDrawable;
                    iconDescResId = android.support.v7.mediarouter.R.string.mr_controller_stop;
                } else if (!isPlaying && isPlayActionSupported()) {
                    iconDrawableAttr = android.support.v7.mediarouter.R.attr.mediaRoutePlayDrawable;
                    iconDescResId = android.support.v7.mediarouter.R.string.mr_controller_play;
                } else {
                    visible = false;
                }
    ...
    void updateArtIconIfNeeded() {
        ...
        mFetchArtTask = new CustomMediaRouteControllerDialog.FetchArtTask();
    ...
    private final class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteVolumeChanged(MediaRouter router, MediaRouter.RouteInfo route) {
            ...
            if (DEBUG) {
                Timber.d("onRouteVolumeChanged(), route.getVolume:" + volume);
            }
    ...
    private final class ClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (id == BUTTON_STOP_RES_ID || id == BUTTON_DISCONNECT_RES_ID) {
                ...
                dismiss();
            } else if (id == android.support.v7.mediarouter.R.id.mr_control_playback_ctrl) {
                if (mMediaController != null && mState != null) {
                    ...
                    if (isPlaying && isPauseActionSupported()) {
                        ...
                        actionDescResId = android.support.v7.mediarouter.R.string.mr_controller_pause;
                    } else if (isPlaying && isStopActionSupported()) {
                        mMediaController.getTransportControls().stop();
                        actionDescResId = android.support.v7.mediarouter.R.string.mr_controller_stop;
                    } else if (!isPlaying && isPlayActionSupported()){
                        mMediaController.getTransportControls().play();
                        actionDescResId = android.support.v7.mediarouter.R.string.mr_controller_play;
                    }
            ...
            } else if (id == android.support.v7.mediarouter.R.id.mr_close) {
                dismiss();
            }
        }
    }
    ...
    private class VolumeChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            if (fromUser) {
                ...
                if (DEBUG) {
                    Timber.d("onProgressChanged(): calling "
    ...
    private class VolumeGroupAdapter extends ArrayAdapter<MediaRouter.RouteInfo> {
        ...
        VolumeGroupAdapter(Context context, List<MediaRouter.RouteInfo> objects) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                v = LayoutInflater.from(parent.getContext()).inflate(
                        android.support.v7.mediarouter.R.layout.mr_controller_volume_item, parent, false);
            } else {
            ...
            if (route != null) {
                ...
                TextView routeName = (TextView) v.findViewById(android.support.v7.mediarouter.R.id.mr_name);
                routeName.setEnabled(isEnabled);
                routeName.setText(route.getName());

                MediaRouteVolumeSlider volumeSlider =
                        (MediaRouteVolumeSlider) v.findViewById(android.support.v7.mediarouter.R.id.mr_volume_slider);
...
//                        parent.getContext(), volumeSlider, mVolumeGroupList);
                ...
                ImageView volumeItemIcon =
                        (ImageView) v.findViewById(android.support.v7.mediarouter.R.id.mr_volume_item_icon);
                ...
                // the animation ends.
                LinearLayout container = (LinearLayout) v.findViewById(android.support.v7.mediarouter.R.id.volume_item_container);
    ...
    private class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        FetchArtTask() {
            ...
            if (isBitmapRecycled(bitmap)) {
                Timber.w("Can't fetch the given art bitmap because it's already recycled.");
                bitmap = null;
            }
            mIconBitmap = bitmap;
        ...
        protected Bitmap doInBackground(Void... arg) {
            ...
            if (mIconBitmap != null) {
                ...
                try {
                    if ((stream = openInputStreamByScheme(mIconUri)) == null) {
                        Timber.tag(TAG).w("Unable to open: " + mIconUri);
                        return null;
                    }
                    // Query art size.
                    ...
                    try {
                        ...
                        stream.close();
                        if ((stream = openInputStreamByScheme(mIconUri)) == null) {
                            Timber.w("Unable to open: " + mIconUri);
                            return null;
                        }
                    }
                    ...
                    Timber.w(e, "Unable to open: " + mIconUri);
                } finally {
                    if (stream != null) {
                        try {
                            stream.close();
            ...
            if (isBitmapRecycled(art)) {
                Timber.w("Can't use recycled bitmap: " + art);
                return null;
            }
